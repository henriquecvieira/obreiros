...
class RepositoryWrapper {
  ...
  async getScheduleByDate(collection, startDate, endDate) {
    const statement = this.queries.getScheduleByDate
    return this.impl.find(collection, statement.query(startDate, endDate))
  }
